...
<body>
	...
	<div class="container">
		...
		<h2 align="center">Please add a new teacher by entering its
			information</h2>
	</div>
	<div class="container">
		<%
				...
				<div class="col-lg-6 col-lg-offset-3">
					<div class="form-group">
						<label for="name">Teacher's Name:*</label> <input type="text"
							class="form-control" id="teacherName" placeholder="Enter Name"
							name="name" value=<%=name%>>
					</div>
					<div class="form-group">
						<label for="name">Teacher's Email:*</label> <input type="text"
							class="form-control" id="teacherEmail" placeholder="Enter Email"
